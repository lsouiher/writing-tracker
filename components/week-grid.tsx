        ...
        {weeks.map((week) => {
          ...
          return (
            <Link
              ...
              className={`flex h-11 items-center justify-center rounded text-xs transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent ${getShadingClass(daysCount)} ${
